 ...
 * @author D1996e
 */
public class StateTurnOn implements States{

    private static int count = 0;
    private Server server;
    private Client client;

    public StateTurnOn(Server server, Client client)
    {
        this.server = server;
        this.client = client;
    }
    ...
    {
        count++;
        System.out.println("Ended your turn " + count);
        sendMsg();
        context.setState(new StateTurnOff(server, client));
    }
